...
ggplot() +
  ...
  scale_color_manual(
    name = NULL,
    values = c(
      "α OFI 2017" = "royalblue", "α OFI 2024" = "royalblue",
      "α TFI 2017" = "springgreen2", "α TFI 2024" = "springgreen2",
      "β OFI 2017" = "firebrick", "β OFI 2024" = "firebrick",
      "β TFI 2017" = "orange", "β TFI 2024" = "orange"
    )
  ) +
  # Line types
  scale_linetype_manual(
...
ggplot() +
  ...
  scale_color_manual(
    ...
    values = c(
      ...
      "β OFI 2017" = "#c65911",  # Dark orange for beta OFI
      "β OFI 2024" = "#c65911",  # Dark orange for beta OFI
      "β TFI 2017" = "#ffa500",  # Bright orange for beta TFI
      "β TFI 2024" = "#ffa500"   # Bright orange for beta TFI
    )
  ) +
